...
const News = () => {
  const mapsArray = [
    {
      title: "Disney divulga data de estreia do live-action 'Lilo e Stitch' no Brasil; saiba mais",
    ...
    {
      title: "Fernanda Montenegro comemora 95 anos; confira a lista de filmes marcantes da atriz, e onde assistir",
      description:
    ...
    {
      title: "Inspirado na obra de Stephen King, terror ‘O Macaco’ ganha trailer arrepiante; assista",
      description: "Theo James (‘Divergente’) estrela o longa, que chega às telonas em fevereiro de 2025",
      img: "https://ingresso-a.akamaihd.net/b2b/production/uploads/article/image/2684/a44efc0c41151f54e20124088050a1cf.jpg",
    },
    {
      title: "Como Christopher Reeve, o eterno Superman, transformou a luta por direitos das pessoas com paralisia",
      description: "Documentário sobre a trajetória do ator estreia nos cinemas esta semana",
    ...
    },
    {
      ...
      description: "Novo filme do renomado diretor chega às telonas no final deste mês",
      img: "https://ingresso-a.akamaihd.net/b2b/production/uploads/article/image/2682/b11b53b556ac0c1b77ea052d6ef56c8f.jpg",
    },
    {
      title: "Pré-venda de 'Som da Esperança - A História de Possum Trot' já tem data para começar no Brasil",
    ...
    {
      title: "Sequência da comédia teen, 'Sexta-Feira Muito Louca 2' ganha data de estreia nos cinemas do Brasil",
      description: "Jamie Lee Curtis e Lindsay Lohan retornam aos seus papéis na continuação",
